...
void AnalogTest(void) {
	...
	HAL_GPIO_WritePin(LightOut1_GPIO_Port, LightOut1_Pin, GPIO_PIN_RESET);

	HAL_GPIO_WritePin(LightOut1_GPIO_Port, LightOut2_Pin, GPIO_PIN_SET);
	HAL_Delay(1);
	uint16_t vLight2 = AdcGet(0);
	PrintfUart("Light2  1KOhm: %u\r\n", vLight2);
	HAL_GPIO_WritePin(LightOut2_GPIO_Port, LightOut2_Pin, GPIO_PIN_RESET);
